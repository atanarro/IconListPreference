...
public class IconListPreferenceTestActivity extends PreferenceActivity
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		test4.setEntryValues(new CharSequence[] { "C", "D", "E", "F", "G", "H",
				"I" });

		test4.setEntryIcons(new int[] { R.drawable.cupcake, R.drawable.donut,
		...
		test4.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
			...
			public boolean onPreferenceChange(Preference preference,
				...
				Toast.makeText(IconListPreferenceTestActivity.this,
						(CharSequence) newValue, Toast.LENGTH_LONG).show();
				return false;
			}
		});
	...
	public void onSharedPreferenceChanged(SharedPreferences sharedPreferences,
			String key) {
		//Toast.makeText(IconListPreferenceTestActivity.this,
		//		(CharSequence) sharedPreferences.getString(key, ""), Toast.LENGTH_LONG).show();		
